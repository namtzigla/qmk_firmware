...
[_MDIA] = KEYMAP_5x6(
       ...
       _______, KC_ACL1, KC_BTN1, KC_MS_U, KC_BTN2, _______,
       _______, KC_ACL2, KC_MS_L, KC_MS_D, KC_MS_R, _______,
       RESET  , _______, KC_WH_U, KC_WH_D, _______, _______,
                         _______, _______,
                                           _______, _______,
                                           _______, _______,
                                           _______, _______,
    // right hand
       _______, _______, KC_WSCH, _______, _______, _______,
       _______, _______, _______, _______, _______, _______,
       _______, KC_WBAK, KC_WSTP, KC_WFWD, _______, _______,
       _______, _______, KC_WREF, _______, _______, _______,
                         _______, _______,
       _______, _______,
       _______, _______,
       _______, _______
